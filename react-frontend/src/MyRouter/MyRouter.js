...
import SingleIPBDPage from "../components/app_components/IPBDPage/SingleIPBDPage";
import IPBDProjectLayoutPage from "../components/app_components/IPBDPage/IPBDProjectLayoutPage";
//  ~cb-add-import~
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/iPBD/:singleIPBDId" exact element={<SingleIPBDPage />} />
<Route path="/iPBD" exact element={<IPBDProjectLayoutPage />} />
